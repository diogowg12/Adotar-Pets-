...
def processa_pedido_adocao(request,id_pedido):
    ...
    email = send_mail(
        ...
        string,
        'diogowg.lima11@gmail.com',
        [pedido.usuario.email,],
    )

    messages.add_message(request, constants.SUCESS, 'Pedido de adoção processado com sucesso')
    return redirect('/divulgar/ver_pedido_adocao')

#fazer desafio para o usuario digitar apenas uma raça

#tarefa,fazer com que o usurio não solicite o mesmo pet
